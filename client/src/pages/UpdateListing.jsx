                ...
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleChange} value={formData.bedrooms} type='number' className='p-3 border border-gray-300 rounded-lg' id='bedrooms' min='1' max='10' />
                            <p>Beds</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleChange} value={formData.bathrooms} type='number' className='p-3 border border-gray-300 rounded-lg' id='bathrooms' min='1' max='10' />
                            <p>Baths</p>
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleChange} value={formData.regularPrice} type='number' className='p-3 border border-gray-300 rounded-lg' id='regularPrice' min='50' max='1000000' />
                        ...
                        {formData.offer && (
                            <div className='flex items-center gap-2'>
                                <input onChange={handleChange} value={formData.discountPrice} type='number' className='p-3 border border-gray-300 rounded-lg' id='discountPrice' min='0' max='10000000' />
                                <div className='flex flex-col items-center'>
